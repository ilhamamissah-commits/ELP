...
const LESSONS: HistoryLesson[] = [
  ...
  },
  {
    ...
    reflection:
      "What qualities would make someone a trustworthy leader?",
    question: {
  ...
  },
  {
    ...
    reflection:
      "Why is fairness important when making decisions?",
    question: {
  ...
  },
  {
    ...
    reflection:
      "What type of design or art would you like to create?",
    question: {
...
export const IslamicHistory: React.FC<IslamicHistoryProps> = ({ onComplete }) => {
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8 rounded-2xl border border-slate-200 p-6 text-left">
            ...
            <ul className="mt-4 space-y-3 text-sm leading-6 text-slate-600">
              ...
              <li>
                • Learn about the Rightly Guided Caliphs.
              </li>
              <li>
                • Understand the importance of knowledge and civilization.
              </li>
              <li>
                • Recognize the diversity of Muslim communities around the world.
              </li>
              <li>
        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-600">
              Explore important people, events, civilizations, and communities.
            </p>
          </div>
