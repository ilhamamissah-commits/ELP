      ...
      >
        ...
        <div className="text-left bg-gray-900 rounded-2xl p-5 mt-6">
          ...
          <ul className="mt-4 space-y-2 text-sm text-gray-300 leading-6">
            ...
            <li>
              • Identify basic Arabic letters and harakat.
            </li>
            ...
            <li>
              • Begin connecting recitation with understanding.
            </li>
          </ul>
        </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Build strong foundations before moving into advanced Qur'an study.
            </p>
          </div>
      ...
      <div className="bg-app-card border border-app-border rounded-2xl p-4">
        <div className="flex gap-3">
          ...
          <p className="text-xs text-gray-500 leading-5">
            ...
            memorisation sequences, and Qur'anic interpretations should be
            expanded using carefully reviewed Qur'an, Hadith, and qualified
            teacher-approved learning materials.
          </p>
        </div>
      </div>
    </motion.div>
