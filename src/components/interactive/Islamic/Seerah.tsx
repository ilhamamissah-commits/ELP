...
const LESSONS: SeerahLesson[] = [
  {
    ...
    emoji: '🌙',
    period: 'Makkah',
    summary: 'Prophet Muhammad ﷺ was born in Makkah into Quraysh.',
    detail:
  ...
  },
  {
    ...
    reflection: 'Why is trust important in friendships and communities?',
    question: {
  ...
  },
  {
    ...
    reflection: 'Why is learning and reading important in Islam?',
    question: {
  ...
  },
  {
    ...
    reflection: 'Who can you speak to when you are facing a serious problem?',
    question: {
      question: 'How did the Prophet ﷺ respond to opposition?',
      options: [
  ...
  },
  {
    ...
    question: {
      question: 'What helped strengthen the community in Madinah?',
      options: [
  ...
  },
  {
    ...
    question: {
      ...
      options: ['Mercy', 'Cruelty', 'Dishonesty', 'Arrogance'],
      answer: 'Mercy',
      explanation:
  ...
  },
  {
    ...
    reflection: 'How can you remain humble when you succeed?',
    question: {
      question:
  ...
  },
  {
    ...
    reflection: 'What is one way you can treat other people fairly?',
    question: {
      question:
...
export const Seerah: React.FC<SeerahProps> = ({ onComplete }) => {
  ...
  // Reset per-lesson + auto-read the story or prompt
  useEffect(() => {
    ...
    const readOut =
      mode === 'guided'
        ? `${current.title}. ${current.summary}. ${current.detail}`
  ...
  const completeGuided = () => {
    if (!currentProgress.mastered) {
      ...
      speak('Well done. You understood this event.');
    }
  ...
  const checkAnswer = () => {
    ...
    if (!correct) {
      ...
      speak(
        `Let's review this event. The best answer is: ${current.question.answer}. ${current.question.explanation}`,
      );
  ...
  const reset = () => {
    ...
    speak("Let's explore the Seerah again!");
  };
  ...
  const finish = () => {
    ...
    speak(
      `Masha'Allah! You mastered ${masteredCount} of ${LESSONS.length} events and earned ${score} points.`,
    );
  };
      ...
      >
        ...
        <div className="grid grid-cols-3 gap-3 mt-8">
          <div className="bg-gray-900 rounded-2xl p-4">
            ...
            <p className="text-xs text-gray-500">Events mastered</p>
          </div>
        ...
        <div className="text-left bg-gray-900 rounded-2xl p-5 mt-6">
          ...
          <ul className="mt-4 space-y-2 text-sm text-gray-300 leading-6">
            ...
            <li>
              • Recognize the importance of the Prophet&apos;s character.
            </li>
    ...
    >
      ...
      <div className="bg-app-card p-6 rounded-3xl border border-app-border shadow-xl">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <h3 className="text-2xl font-bold text-white mt-1">Seerah</h3>
      ...
      >
          ...
          <>
            ...
            <div className="grid gap-3 sm:grid-cols-3 mt-5">
              {current.lessons.map((lesson) => (
                <div key={lesson} className="bg-gray-900 rounded-xl p-4">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mb-2" />

                  <p className="text-sm text-gray-300 leading-6">{lesson}</p>
                </div>
              ))}
            </div>
        ...
        <div className="flex gap-3 mt-7 pt-6 border-t border-gray-800">
          ...
          >
            {index === LESSONS.length - 1 ? 'Complete' : 'Next Event'}
      ...
      <div className="bg-app-card border border-app-border rounded-2xl p-4">
        <div className="flex gap-3">
          ...
          <p className="text-xs text-gray-500 leading-5">
            ...
            age-appropriate learning. Detailed historical narratives, dates,
            reports, and Hadith references should be expanded and reviewed
            against reliable Islamic sources before being used as advanced
            curriculum content.
          </p>
        </div>
      </div>
