...
const LESSONS: TarbiyahLesson[] = [
  {
    ...
    practice: 'Do one good action today without telling anyone about it.',
    reflection:
  ...
  },
  {
    ...
    practice: 'Tell the truth even when it is difficult.',
    reflection: 'How can telling the truth help people trust you?',
    keyPoints: [
      'Speak truthfully.',
  ...
  },
  {
    ...
    reflection: 'What can you do when you feel impatient?',
    keyPoints: [
  ...
  },
  {
    ...
    practice: 'Name three blessings you are thankful for.',
    reflection:
    ...
    question: {
      question: 'Which action shows gratitude?',
      options: [
  ...
  },
  {
    ...
    practice: 'Do something kind for another person today.',
    reflection: 'How does kindness make a community better?',
    keyPoints: [
      'Use kind words.',
    ...
    question: {
      question: 'A classmate drops their books. What is a kind response?',
      options: [
  ...
  },
  {
    ...
    reflection: 'Why can forgiveness sometimes be difficult?',
    keyPoints: [
  ...
  },
  {
    ...
    practice: 'Complete one responsibility without being reminded.',
    reflection: 'What responsibility can you take more seriously?',
    keyPoints: [
  ...
  },
  {
    ...
    practice: 'Stand up for what is right in a respectful way.',
    reflection: 'Can someone be afraid and still be courageous?',
    keyPoints: [
  ...
  },
  {
    ...
    practice: 'Listen carefully when someone is speaking to you.',
    reflection: 'What does respectful listening look like?',
    keyPoints: [
    ...
    question: {
      question: 'Someone is speaking to you. What shows respect?',
      options: [
  ...
  },
  {
    ...
    reflection: 'What helps you calm down when you are upset?',
    keyPoints: [
      'Pause before reacting.',
    ...
    question: {
      question: 'Someone makes you angry. What is a good first step?',
      options: [
  ...
  },
  {
    ...
    practice: 'Offer useful help with one task today.',
    reflection:
  ...
  },
  {
    ...
    question: {
      question: 'You win a competition. What shows humility?',
      options: [
...
export const Tarbiyah: React.FC<TarbiyahProps> = ({ onComplete }) => {
  ...
  // Reset per-lesson + auto-read the principle and prompt
  useEffect(() => {
    ...
    const readOut =
      mode === 'guided'
        ? `${current.title}. ${current.principle}. ${current.explanation}. Practice today: ${current.practice}`
  ...
  const markGuidedComplete = () => {
    ...
    speak(
      `Well done. You understood and practised ${current.title}.`,
    );
  };
  ...
  const checkAnswer = () => {
    ...
    if (!correct) {
      ...
      speak(
        `Let's learn from this. The best answer is: ${current.question.answer}. ${current.question.explanation}`,
      );
  ...
  const reset = () => {
    ...
    speak("Let's practise good character again!");
  };
      ...
      <div className="bg-app-card p-6 rounded-3xl border border-app-border shadow-xl">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <h3 className="text-2xl font-bold text-white mt-1">Tarbiyah</h3>
      ...
      <div className="bg-app-card border border-app-border rounded-2xl p-4">
        <div className="flex gap-3">
          ...
          <p className="text-xs text-gray-500 leading-5">
            ...
            decision-making. Children should speak to a trusted adult when
            they experience serious harm, bullying, danger, or situations
