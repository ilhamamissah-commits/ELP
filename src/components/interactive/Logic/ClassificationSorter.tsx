...
const CHALLENGES: LogicChallenge[] = [
  {
    ...
    answer: '🍎',
    explanation:
      'An apple is a fruit. The dog is an animal, the car is a vehicle, and the shirt is clothing.',
    hint: 'Think about something you can eat that grows from a plant.',
    learningPoint:
      'Classification means putting things into groups based on what they have in common.',
  },
  {
    id: 2,
    level: 1,
  ...
  },
  {
    ...
    answer: '🐶',
    explanation:
      'The apple, banana, and strawberry are fruits. The dog is an animal.',
    hint: 'Look at what you can eat.',
    learningPoint:
      'Odd-one-out problems help us notice similarities and differences.',
  },
  {
    id: 5,
    level: 1,
    ...
    learningPoint:
      'Classification helps us organize information into meaningful groups.',
  },
  {
    id: 6,
    level: 1,
    ...
    learningPoint:
      'Careful observation is an important part of logical thinking.',
  },
  {
    id: 7,
    level: 1,
    ...
    learningPoint:
      'We can classify objects according to their use and properties.',
  },
  {
    id: 8,
    level: 1,
    ...
    learningPoint:
      'Logical classification can use function as well as appearance.',
  },
  {
    id: 9,
    level: 2,
    ...
    answer: '🔴',
    explanation:
      'The pattern repeats red, blue, red, blue. The next item is red.',
  ...
  },
  {
    ...
    answer: '🔺',
    explanation:
      'The two-shape pattern repeats triangle, square, triangle, square.',
    hint: 'Look at the first two shapes and repeat them.',
    learningPoint:
      'Recognizing repetition helps us predict what comes next.',
  },
  {
    id: 11,
    level: 2,
  ...
  },
  {
    ...
    learningPoint:
      'Sequences can be built by alternating between items.',
  },
  {
    id: 14,
    level: 2,
    ...
    answer: 'Small',
    explanation:
      'If the sequence repeats, the next item returns to small.',
    hint: 'The sequence goes small, medium, large and starts again.',
    learningPoint:
      'Sequences can repeat after reaching the end of a cycle.',
  },
  {
    id: 15,
    level: 2,
    ...
    answer: '🍎',
    explanation:
      'The car, bus, and bicycle are used for transportation. The apple is food.',
    hint: 'Think about how the objects are used.',
    learningPoint:
      'Logical thinkers compare items using shared properties.',
  },
  {
    id: 16,
    level: 2,
    ...
    answer: '🟢',
    explanation:
      'The pattern is two green circles followed by one blue circle.',
    hint: 'Group the pattern as: green, green, blue.',
    learningPoint:
      'Breaking a pattern into smaller groups can make it easier to solve.',
  },
  {
    id: 17,
    level: 3,
    ...
    learningPoint:
      'Deduction means using information to work out a sensible answer.',
  },
  {
    id: 18,
    level: 3,
    ...
    learningPoint:
      'Cause-and-effect reasoning helps us understand why things happen.',
  },
  {
    id: 19,
    level: 3,
    ...
    explanation:
      'After placing a seed in suitable soil, we need to provide water so it can begin growing.',
    hint: 'Plants need water to grow.',
    learningPoint:
      'Good reasoning helps us understand the order in which actions should happen.',
  },
  {
    id: 20,
    level: 3,
    ...
    learningPoint:
      'Deduction uses known information to make a reasonable conclusion.',
  },
  {
    id: 21,
    level: 3,
    ...
    learningPoint:
      'Problem solving means choosing an action or tool that fits the problem.',
  },
  {
    id: 22,
    level: 3,
    ...
    explanation:
      'A stone is generally heavier than a feather, bubble, or leaf of similar size.',
    hint: 'Think about what would fall quickly when dropped.',
    learningPoint:
      'Reasoning can use observations about the physical world.',
  },
  {
    id: 23,
    level: 3,
    ...
    learningPoint:
      'Spatial reasoning helps us understand where objects are in relation to one another.',
  },
  {
    id: 24,
    level: 3,
    ...
    question:
      'All cats in this group have four legs. Mimi is a cat. What can we conclude?',
    options: [
      'Mimi has four legs.',
      'Mimi is a bird.',
      'Mimi is a car.',
    ...
    explanation:
      'If every cat in the group has four legs and Mimi is a cat, Mimi has four legs.',
    hint: 'Use both pieces of information together.',
    learningPoint:
      'Logical conclusions can be made by combining facts.',
  },
  {
    id: 25,
    level: 4,
    ...
    explanation:
      'A sensible sequence is to prepare the bread, add the filling, and then put the sandwich together.',
    hint: 'You need the ingredients before you can assemble them.',
    learningPoint:
      'Complex problems can be solved by breaking them into ordered steps.',
  },
  {
    id: 26,
    level: 4,
    ...
    question:
      'If the light is red, cars must stop. The light is red. What should cars do?',
    options: ['Stop', 'Speed up', 'Fly', 'Turn into boats'],
    answer: 'Stop',
    explanation:
      'The rule says that when the light is red, cars must stop.',
  ...
  },
  {
    ...
    learningPoint:
      'Finding the rule is an important step in solving patterns.',
  },
  {
    id: 28,
    level: 4,
    ...
    answer: '🔴 5',
    explanation:
      'The colours alternate red and blue while the numbers increase by one.',
    hint: 'There are two patterns: one for colour and one for numbers.',
    learningPoint:
      'Advanced patterns may contain more than one rule at the same time.',
  },
  {
    id: 29,
    level: 4,
    ...
    explanation:
      'A good problem solver tries a simple and safe solution before using more complicated actions.',
    hint: 'Choose the safe solution that directly solves the problem.',
    learningPoint:
      'Good problem solving considers both effectiveness and safety.',
  },
  {
    id: 30,
    level: 4,
    ...
    explanation:
      'A stone is not a living creature and cannot eat lunch.',
    hint: 'Which statement describes something impossible?',
    learningPoint:
      'Logical thinking includes identifying statements that conflict with what we know.',
  },
  {
    id: 31,
    level: 4,
    ...
    learningPoint:
      'Spatial reasoning helps us understand direction and movement.',
  },
  {
    id: 32,
    level: 4,
    ...
    difficulty: 'Hard',
    instruction:
      'Use everything you know about patterns and reasoning.',
    question:
      'There are three boxes. The red box is heavier than the blue box. The blue box is heavier than the green box. Which is lightest?',
    options: ['Red', 'Blue', 'Green', 'They are all equal'],
    answer: 'Green',
    explanation:
      'If red is heavier than blue and blue is heavier than green, green is the lightest.',
    hint: 'Put the three boxes in order from heaviest to lightest.',
    learningPoint:
      'Logical reasoning lets us combine several relationships to reach a conclusion.',
  },
];
...
const LEVEL_INFO = [
  ...
  },
  {
    ...
    title: 'Solve & Think',
    description:
      'Combine rules, sequences and reasoning to solve problems.',
  },
];
...
export const ClassificationSorter: React.FC<ClassificationSorterProps> = ({
  ...
  const currentProgress = currentChallenge
    ? progress[currentChallenge.id] ?? { attempts: 0, mastered: false }
  ...
  const navigationProgress =
    levelChallenges.length > 0
      ? ((currentIndex + (answerChecked ? 1 : 0)) / levelChallenges.length) * 100
      : 0;
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => {
      speak(
        `${currentChallenge.instruction} ${currentChallenge.question}`,
      );
    }, 400);
  ...
  useEffect(() => {
    if (hintShown && currentChallenge && !answerChecked) {
      speak(currentChallenge.hint);
    }
  }, [hintShown, currentChallenge, answerChecked, speak]);
  ...
  useEffect(() => {
    ...
    speak(
      `Level ${currentLevel} complete! You mastered ${levelMastered} of ${levelChallenges.length} challenges. Well done!`,
    );
  }, [isComplete, currentLevel, levelMastered, levelChallenges.length, speak]);
  ...
  const handleAnswer = (option: string) => {
    ...
    updateProgress(currentChallenge.id, (previous) => ({
      ...
      mastered: previous.mastered || (correct && mode === 'mastery'),
    }));

    if (correct) {
      if (soundEnabled) playSoundFeedback('correct');

      const firstMastery = !currentProgress.mastered && mode !== 'guided';
      ...
      speak(`Excellent reasoning! ${currentChallenge.explanation}`);
    } else {
      ...
      speak(
        `Good try. Let's learn from it. ${currentChallenge.explanation}`,
      );
    }
  };
  ...
  const resetModule = () => {
    ...
    speak("Let's practise logic and reasoning again!");
  };
    ...
    <div className="max-w-3xl mx-auto bg-app-card rounded-3xl border border-app-border shadow-xl overflow-hidden">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {currentChallenge.options.map((option) => {
            ...
            if (!answerChecked) {
              ...
              className += 'border-green-400 bg-green-500/10 text-green-300';
            } else if (isSelected) {
              className += 'border-red-400 bg-red-500/10 text-red-300';
            } else {
              className += 'border-gray-800 bg-gray-800/50 text-gray-500';
            }
      ...
      <div className="p-5 sm:p-6 border-t border-app-border flex items-center justify-between gap-3">
        ...
        <div className="text-center">
          <p className="text-xs text-gray-500">{currentChallenge.skill}</p>
        ...
        >
          {currentIndex === levelChallenges.length - 1 ? 'Complete' : 'Next'}
