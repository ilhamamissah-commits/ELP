...
const CHALLENGES: GlobalChallenge[] = [
  ...
  },
  {
    ...
    question: "A classmate has a different idea from you. What is a good first step?",
    options: [
  ...
  },
  {
    ...
    question: "Your group needs to build a large model. What is a good approach?",
    options: [
  ...
  },
  {
    ...
    question: "Two children need the same book for their homework at the same time. What could be a fair solution?",
    options: [
  ...
  // ============================================================
  {
    ...
    answer: 0,
    explanation:
      "Living things need water to survive and stay healthy.",
    keyPoints: [
      "Water supports life.",
  ...
  },
  {
    ...
    type: "perspective",
    emoji: "🍲",
    objective: "Explore how food can be connected to culture and tradition.",
    introduction:
      "Families and communities may have foods that are connected to celebrations, places, history, and traditions.",
    question: "Why might two families eat different foods at a celebration?",
    options: [
  ...
  },
  {
    ...
    question: "You see a tradition that is unfamiliar to you. What is a respectful response?",
    options: [
    ...
    reflection: "What is something about another culture you would like to learn?",
  },

  // ============================================================
  // LEVEL 5 — GEOGRAPHY & OUR WORLD
  // ============================================================
  {
    id: 17,
    level: 5,
    ...
    answer: 0,
    explanation:
      "Africa is one of the commonly taught continents.",
    keyPoints: [
  ...
  // ============================================================
  {
    ...
    type: "perspective",
    emoji: "🚰",
    objective: "Understand that access to safe water matters to communities.",
    introduction:
      "Communities need reliable access to safe water for drinking, cooking, hygiene, farming, and other needs.",
    question: "If a community has difficulty getting safe water, what should people investigate?",
    options: [
  ...
  },
  {
    ...
    type: "perspective",
    emoji: "📚",
    objective: "Understand why education can be important to communities.",
    introduction:
  ...
  },
  {
    ...
    type: "perspective",
    emoji: "🌍",
    objective: "Think about how communities make decisions about shared resources.",
    introduction:
      "Some resources are shared by many people. Decisions about them can affect different groups.",
    question: "Before making a decision about a shared resource, what should a community consider?",
    options: [
  ...
  // ============================================================
  {
    ...
    type: "perspective",
    emoji: "👀",
    objective: "Understand that people can experience the same situation differently.",
    introduction:
      "Two people can see the same event but describe it differently because they have different experiences or roles.",
    question: "Two children disagree about whether a game was fair. What should they do?",
    options: [
    ...
    reflection: "Have you ever understood something differently from a friend?",
  },
  {
    id: 26,
    level: 7,
  ...
  },
  {
    ...
    question: "Someone says, 'The playground is always empty.' What would be useful evidence?",
    options: [
  ...
  },
  {
    ...
    type: "perspective",
    emoji: "🔄",
    objective: "Practise considering how different people may experience an issue.",
    introduction:
      "A decision that helps one person may create a challenge for someone else.",
    question: "A park is going to be redesigned. Who should the community consider?",
    options: [
  ...
  // ============================================================
  // LEVEL 8 — RESEARCH & INVESTIGATION
  // ============================================================
  {
    id: 29,
    level: 8,
  ...
  },
  {
    ...
    question: "You record how much water three plants receive. What could comparison help you discover?",
    options: [
  ...
  },
  {
    ...
    question: "If repeated observations show that a plant grows taller when it receives enough water, what is a reasonable conclusion?",
    options: [
  ...
  // ============================================================
  // LEVEL 9 — COLLABORATION & COMMUNICATION
  // ============================================================
  {
    id: 33,
    level: 9,
  ...
  },
  {
    ...
    question: "Your team has two possible solutions. What should you do?",
    options: [
  ...
  },
  {
    ...
    question: "A community wants to reduce plastic waste. What should they investigate?",
    options: [
  ...
  },
  {
    ...
    type: "perspective",
    emoji: "💡",
    objective: "Connect evidence and perspectives to a possible solution.",
    introduction:
...
const LEVELS = [
  {
    level: 1,
    title: "Me & My World",
    description: "Understand yourself, your community, and everyday decisions.",
    icon: <Users className="w-5 h-5" />,
  },
  {
    level: 2,
    title: "People & Communities",
    description: "Explore cooperation, fairness, rules, and community problems.",
    icon: <Users className="w-5 h-5" />,
  },
  {
    level: 3,
  ...
  },
  {
    ...
    description: "Learn about languages, traditions, homes, and respectful curiosity.",
  ...
  },
  {
    level: 6,
    title: "Global Issues",
    description: "Think about challenges that affect people and environments.",
  ...
  },
  {
    ...
    description: "Work with others, explain ideas, and reflect on teamwork.",
    icon: <Users className="w-5 h-5" />,
  },
  {
    level: 10,
