...
const CHALLENGES: HistoryChallenge[] = [
  ...
  },
  {
    ...
    answer: 0,
    explanation:
      "People grow and develop over time, showing change.",
    keyPoints: [
  ...
  },
  {
    ...
    emoji: "👨‍👩‍👧‍👦",
    objective: "Understand that family stories can provide information about the past.",
    introduction:
    ...
    reflection: "What family object or photograph would you like to learn about?",
  },
  {
    id: 4,
    level: 1,
  ...
  },
  {
    ...
    question: "What could be different about a doctor's work today compared with long ago?",
    options: [
    ...
    reflection: "Which job would you like to compare across different time periods?",
  },
  {
    id: 8,
    level: 2,
    ...
    skill: "Historical Evidence",
    emoji: "🗣️",
    objective: "Understand that people's memories can provide historical information.",
    introduction:
  ...
  },
  {
    ...
    skill: "Chronology",
    emoji: "🇬🇭",
    objective: "Introduce Ghana's independence as an important historical event.",
    introduction:
    ...
    answer: 0,
    explanation:
      "Ghana gained independence on 6 March 1957.",
    keyPoints: [
  ...
  },
  {
    ...
    skill: "Historical Evidence",
    emoji: "🇬🇭",
    objective: "Recognize Kwame Nkrumah's role in Ghana's independence history.",
    introduction:
    ...
    reflection: "What would you like to learn about Ghana's independence movement?",
  },

  // ============================================================
  // LEVEL 4 — AFRICAN CIVILIZATIONS
  // ============================================================
  {
    id: 13,
    level: 4,
  ...
  },
  {
    ...
    skill: "Historical Evidence",
    emoji: "🔺",
    objective: "Understand that ancient structures provide evidence about past societies.",
    introduction:
  ...
  },
  {
    ...
    skill: "Cultural Awareness",
    emoji: "👑",
    objective: "Introduce the Mali Empire and its role in West African history.",
    introduction:
  ...
  },
  {
    ...
    skill: "Historical Evidence",
    emoji: "🧱",
    objective: "Recognize Great Zimbabwe as evidence of complex African societies.",
    introduction:
  ...
  },
  {
    ...
    skill: "Cultural Awareness",
    emoji: "🏯",
    objective: "Recognize the long history and contributions of Chinese civilization.",
    introduction:
    ...
    reflection: "Which historical invention do you think changed people's lives?",
  },

  // ============================================================
  // LEVEL 6 — PEOPLE & CHANGE
  // ============================================================
  {
    id: 21,
    level: 6,
  ...
  },
  {
    ...
    reflection: "How would you send a message if there were no phones or internet?",
  },
  {
    id: 24,
    level: 6,
    ...
    question: "If a new transport system makes travel faster, what could happen?",
    options: [
  ...
  // ============================================================
  {
    ...
    reflection: "What would you ask an astronaut who travelled to the Moon?",
  },
  {
    id: 26,
    level: 7,
    ...
    skill: "Cause and Effect",
    emoji: "✊",
    objective: "Understand that independence can result from organised movements and political change.",
    introduction:
      "During the 20th century, many countries experienced movements seeking independence from colonial rule.",
    question: "What is an independence movement generally trying to achieve?",
    options: [
    ...
    reflection: "Why might people want their community or country to govern itself?",
  },
  {
    id: 27,
    level: 7,
  ...
  },
  {
    ...
    question: "Why do historians study events that happened before other events?",
    options: [
    ...
    reflection: "Can you think of something today that was influenced by something in the past?",
  },

  // ============================================================
  // LEVEL 8 — HISTORICAL THINKING
  // ============================================================
  {
    id: 29,
    level: 8,
    ...
    question: "If Event A happened in 1957 and Event B happened in 1969, which happened first?",
    options: ["Event A", "Event B", "They happened at the same time"],
    answer: 0,
    explanation:
      "1957 comes before 1969.",
    keyPoints: [
  ...
  },
  {
    ...
    question: "If a new road connects two communities, what could be one consequence?",
    options: [
  ...
  },
  {
    ...
    question: "A community gets smartphones but people still gather for family meals. What does this show?",
    options: [
    ...
    reflection: "What has changed and what has stayed the same in your family?",
  },
  {
    id: 32,
    level: 8,
    ...
    skill: "Comparison",
    emoji: "🔍",
    objective: "Practise comparing historical societies without assuming one is automatically better.",
    introduction:
  ...
  // ============================================================
  {
    ...
    reflection: "What questions would you ask when looking at an old photograph?",
  },
  {
    id: 34,
    level: 9,
    ...
    skill: "Perspective",
    emoji: "👥",
    objective: "Understand that historical accounts can reflect different perspectives.",
    introduction:
      "Different people can experience the same event differently. Historians can examine multiple accounts.",
    question: "Why might two people describe the same historical event differently?",
    options: [
    ...
    reflection: "Why can listening to more than one person help us understand an event?",
  },
  {
    id: 35,
    level: 9,
    ...
    skill: "Historical Evidence",
    emoji: "📚",
    objective: "Introduce the distinction between primary and secondary sources.",
    introduction:
    ...
    question: "Which could be a primary source for studying a historical event?",
    options: [
  ...
  },
  {
    ...
    question: "You find one old photograph showing an empty street. Can you conclude the whole town was always empty?",
    options: [
  ...
  // ============================================================
  {
    ...
    skill: "Critical Thinking",
    emoji: "📖",
    objective: "Understand that studying the past can help people think about the present.",
    introduction:
  ...
  },
  {
    ...
    question: "What is a good first step when investigating your community's history?",
    options: [
    ...
    answer: 0,
    explanation:
      "A clear question gives your investigation direction.",
    keyPoints: [
    ...
    reflection: "What question would you ask about your community's past?",
  },
  {
    id: 39,
    level: 10,
  ...
  },
  {
    ...
    skill: "Reflection",
    emoji: "🌟",
    objective: "Understand that today's actions become part of tomorrow's history.",
    introduction:
...
const LEVELS = [
  ...
  },
  {
    ...
    description: "Explore important people, places, events, and developments in Ghana.",
  ...
  },
  {
    level: 6,
    title: "People & Change",
    description: "Discover how inventions, technology, and ideas changed societies.",
  ...
  },
  {
    ...
    description: "Practise chronology, cause and effect, comparison, and change.",
    icon: <Search className="w-5 h-5" />,
  },
  {
    level: 9,
    title: "Perspectives & Evidence",
    description: "Learn how historians use sources and consider different perspectives.",
    icon: <MessageCircle className="w-5 h-5" />,
  },
  {
    level: 10,
    title: "Past, Present & Future",
    description: "Connect historical knowledge with today's world and tomorrow.",
...
export const HistoryExplorer: React.FC<HistoryExplorerProps> = ({
  ...
  const levelChallenges = useMemo(() => {
    ...
    return CHALLENGES.filter(
      (challenge) => challenge.level === selectedLevel
    );
  }, [selectedLevel]);
  ...
  if (isComplete) {
    ...
    const masteryPercentage =
      levelChallenges.length === 0
        ? 0
        : Math.round(
            (levelMastered / levelChallenges.length) * 100
          );
          ...
          <div className="space-y-3">
            {currentChallenge.options.map(
              (option, optionIndex) => {
                ...
                const correct =
                  answerChecked &&
                  currentChallenge.answer === optionIndex;

                return (
                  <motion.button
                    key={option}
                    whileHover={
                      !answerChecked ? { scale: 1.01 } : undefined
                    }
                    whileTap={
                      !answerChecked ? { scale: 0.99 } : undefined
                    }
