...
const STEPS: readonly WashingHandsStep[] = [
  {
    id: 'wet-hands',
    icon: '💧',
  ...
  },
  {
    ...
    title: 'Add Soap',
    description:
      'Put enough soap on your hands to cover all the surfaces.',
  },
  {
    id: 'rub-palms',
    icon: '🤲',
    title: 'Rub Your Palms',
    description:
      'Rub your palms together to spread the soap and make bubbles.',
  },
  {
    id: 'between-fingers',
    icon: '👋',
    title: 'Wash Between Your Fingers',
    description: 'Interlock your fingers and clean carefully between them.',
  },
  {
    id: 'clean-nails',
    icon: '💅',
    title: 'Clean Under Your Nails',
    description:
      'Gently scrub under your fingernails where dirt and germs can hide.',
  },
  {
    id: 'rinse',
    icon: '🌊',
    title: 'Rinse Well',
    description:
      'Rinse your hands thoroughly with clean running water until the soap is gone.',
  },
  {
    id: 'dry-hands',
    icon: '🧻',
    title: 'Dry Your Hands',
    description: 'Dry your hands completely with a clean towel or hand dryer.',
  },
] as const;

const WASHING_HANDS_ACTIVITY_ID = 'practical-life-washing-hands-001';

const WASHING_HANDS_SKILLS = [
  'practical-life-hand-hygiene',
  'practical-life-self-care',
  'practical-life-health-awareness',
...
export const WashingHands: React.FC = () => {
  ...
  useEffect(() => {
    ...
    speak(
      'Excellent work! You completed all seven steps of the hand-washing routine. Clean hands help protect you and the people around you from germs.',
    );
  }, [completed, speak]);
  ...
  const handleNext = (): void => {
    ...
    completeActivity({
      id: WASHING_HANDS_ACTIVITY_ID,
      score: 100,
      academyId: 'montessori',
      domain: 'general',
      skillIds: WASHING_HANDS_SKILLS,
    });
  };
  ...
  const handleRestart = (): void => {
    ...
    speak("Let's practise washing hands again!");
  };
    ...
    <div className="mx-auto w-full max-w-lg overflow-hidden rounded-2xl border border-app-border bg-app-card shadow-xl">
      ...
      <div className="border-b border-app-border px-6 py-5 text-center">
        <div className="mb-2 flex items-center justify-center gap-2">
          ...
          <h3 className="text-2xl font-bold text-white">Washing Hands</h3>
        </div>

        <p className="text-sm text-gray-400">
          Learn the steps for clean, healthy hands.
        </p>
      </div>
      ...
      <div className="px-6 pt-5">
        ...
        <div
          ...
          aria-label="Hand washing progress"
        >
          <motion.div
      ...
      <div className="p-6">
        {completed ? (
          ...
          >
            ...
            >
              <span className="text-6xl" role="img" aria-label="Clean hands">
                🌟
              </span>
            </motion.div>
            ...
            <p className="mb-6 text-sm leading-6 text-gray-400">
              You completed all seven steps of the hand-washing routine. Clean
              hands help protect you and the people around you from germs.
            </p>
            ...
            <div className="mb-6 rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4">
              ...
              <p className="text-xs leading-5 text-gray-400">
                Hand hygiene, self-care, health awareness, sequencing, and
