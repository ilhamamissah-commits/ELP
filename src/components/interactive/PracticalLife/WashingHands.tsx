...
const STEPS: readonly WashingHandsStep[] = [
  ...
  },
  {
    ...
    description:
      'Interlock your fingers and clean carefully between them.',
  },
  {
    id: 'clean-nails',
    icon: '💅',
...
const WASHING_HANDS_ACTIVITY_ID =
  'practical-life-washing-hands-001';
        ...
        {completed ? (
          ...
          >
            ...
            <p className="mb-6 text-sm leading-6 text-gray-400">
              You completed all seven steps of the hand-washing
              routine. Clean hands help protect you and the people
            ...
            <div className="mb-6 rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4">
              ...
              <p className="text-xs leading-5 text-gray-400">
                Hand hygiene, self-care, health awareness,
                sequencing, and independence skills have been
                practiced.
              </p>
            </div>
