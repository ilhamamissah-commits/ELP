...
const STEPS: readonly PlantCareStep[] = [
  ...
  },
  {
    ...
    description: 'Wonderful! You have practiced caring for a living plant.',
  },
] as const;

const WATERING_PLANTS_ACTIVITY_ID = 'practical-life-watering-plants-001';
...
export const WateringPlants: React.FC = () => {
  ...
  useEffect(() => {
    ...
    speak(
      'Wonderful work! You completed the plant-care routine. Caring for living things teaches us patience, observation, responsibility, and respect for our environment.',
    );
  }, [completed, speak]);
  ...
  const handleRestart = (): void => {
    ...
    speak("Let's practise caring for plants again!");
  };
    ...
    <div className="mx-auto w-full max-w-lg overflow-hidden rounded-2xl border border-app-border bg-app-card shadow-xl">
      ...
      <div className="border-b border-app-border px-6 py-5 text-center">
        <div className="mb-2 flex items-center justify-center gap-2">
          ...
          <h3 className="text-2xl font-bold text-white">Caring for Plants</h3>
        </div>
      ...
      <div className="p-6">
        {completed ? (
          ...
          >
            ...
            >
              <span className="text-6xl" role="img" aria-label="Healthy plant">
                🌱
              </span>
            </motion.div>
            ...
            <p className="mb-6 text-sm leading-6 text-gray-400">
              You completed the plant-care routine. Caring for living things
              teaches us patience, observation, responsibility, and respect for
              our environment.
            </p>
            ...
            <div className="mb-6 rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4">
              ...
              <p className="text-xs leading-5 text-gray-400">
                Plant care, observation, environmental care, sequencing,
                responsibility, and independence skills have been practiced.
              </p>
            </div>
