...
const STEPS: readonly FoldingStep[] = [
  {
    id: 'lay-shirt-flat',
    icon: '👕',
    title: 'Lay the Shirt Flat',
    description:
      'Place the shirt neatly on a clean, flat surface. Smooth out any wrinkles.',
  },
  {
    id: 'fold-left-side',
    icon: '↔️',
    title: 'Fold the Left Side',
    description:
      'Bring the left sleeve and side of the shirt inward toward the middle.',
  },
  {
    id: 'fold-right-side',
    icon: '↔️',
    title: 'Fold the Right Side',
    description:
      'Bring the right sleeve and side inward so both sides look even.',
  },
  {
    id: 'fold-in-half',
    icon: '⬇️',
    title: 'Fold in Half',
    description:
      'Fold the bottom of the shirt upward toward the top to make a neat rectangle.',
  },
  {
    id: 'tidy-shirt',
    icon: '📦',
    title: 'Tidy and Neat!',
    description:
      'Smooth the edges and place your neatly folded shirt where it belongs.',
  },
] as const;

const FOLDING_ACTIVITY_ID = 'practical-life-folding-clothes-001';

const FOLDING_SKILLS = [
  'practical-life-dressing-care',
  'practical-life-sequencing',
  'practical-life-order',
...
export const FoldingClothes: React.FC = () => {
  ...
  const handleNext = (): void => {
    ...
    completeActivity({
      id: FOLDING_ACTIVITY_ID,
      score: 100,
      academyId: 'montessori',
      domain: 'general',
      skillIds: FOLDING_SKILLS,
    });
  };
    ...
    <div className="mx-auto w-full max-w-lg overflow-hidden rounded-2xl border border-app-border bg-app-card shadow-xl">
      ...
      <div className="px-6 pt-5">
        ...
        <div
          ...
          aria-label="Folding clothes progress"
        >
          <motion.div
