...
const STEPS: readonly ShoeTyingStep[] = [
  {
    id: 'cross-laces',
    icon: '👟',
    title: 'Cross the Laces',
    description:
      'Hold one lace in each hand and cross them over one another.',
  },
  {
    id: 'make-knot',
    icon: '🪢',
    title: 'Make a Knot',
    description:
      'Take one lace under the other and pull both laces gently to make a secure knot.',
  },
  {
    id: 'make-loop',
    icon: '🔁',
  ...
  },
  {
    ...
    title: 'Pull Through',
    description:
      'Push the lace through the opening and pull gently to form your bow.',
  },
  {
    id: 'shoes-tied',
    icon: '✨',
    title: 'Shoes Tied!',
    description:
      'Great work! Check that your bow is secure and your laces are neatly tied.',
  },
] as const;
...
const SHOE_TYING_SKILLS = [
  ...
  'practical-life-fine-motor-coordination',
  'practical-life-bilateral-coordination',
...
export const TyingShoes: React.FC = () => {
  ...
  const handleNext = (): void => {
    ...
    completeActivity({
      id: SHOE_TYING_ACTIVITY_ID,
      score: 100,
      academyId: 'montessori',
      domain: 'general',
      skillIds: SHOE_TYING_SKILLS,
    });
  };
