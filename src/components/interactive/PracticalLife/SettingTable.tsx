...
const STEPS: readonly TableSettingStep[] = [
  {
    id: 'place-plate',
    icon: '🍽️',
  ...
  },
  {
    id: 'place-knife',
    icon: '🔪',
    title: 'Place the Knife',
    description:
      'Put the knife on the right side of the plate, with the blade facing the plate.',
  },
  {
    id: 'place-spoon',
    icon: '🥄',
...
const TABLE_SETTING_SKILLS = [
  ...
  'practical-life-spatial-awareness',
...
export const SettingTable: React.FC = () => {
  ...
  const handleNext = (): void => {
    ...
    completeActivity({
      id: TABLE_SETTING_ACTIVITY_ID,
      score: 100,
      academyId: 'montessori',
      domain: 'general',
      skillIds: TABLE_SETTING_SKILLS,
    });
  };
